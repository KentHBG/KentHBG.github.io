...
<div class="text-center p-4">
  <img src="../img/M3_dietaryfilters.png" width="700" style="display: inline-block; margin-right: 30px; cursor: pointer;" onclick="openModal(this)">
  <img src="../img/M3_shoppinglistfromrecipe.png" width="700" style="display: inline-block; cursor: pointer;" onclick="openModal(this)">
</div>
